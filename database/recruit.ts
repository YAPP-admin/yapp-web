...
export const RECRUIT_FIELD_NAMES = ["기획자", "디자이너", "개발자"]

export const RECRUIT_FIELD = {
  title: '모집 분야',
  fields: {
    기획자: {
      pm: [
        {
          subTitle: `다음과 같은<br />
                     활동을 합니다🙌`,
          description: `디자이너, 개발자와 함께 6개월 간 프로젝트를 수행합니다.<br />
      ...
      design: [
        {
          subTitle: `다음과 같은<br />
                     활동을 합니다🙌`,
          description: `기획자, 개발자와 함께 6개월 간 프로젝트를 수행합니다.<br />
                        서비스의 기획에 대한 아이디어를 수집, 제시하며<br />
                        서비스 런칭을 목표로 프로젝트를 주도적으로 관리하고 진행합니다.`,
        },
        {
