  ...
  faqs: [
    {
      ...
      description: `YAPP은 기획자, 디자이너, 개발자로 팀을 구성하여 <b>6개월간 하나의 IT 서비스(웹,앱,etc.)를 제작</b>하는 연합 동아리입니다.<br /> 
    ...
    },
    {
      ...
      description: `6개월 내내 꾸준히 활동할 수 있고 배우고자 하는 <b>열의가 충분하다면, 누구든 지원이 가능</b>합니다.<br />
                    현재도 고졸/재직자/졸업자 중 활발히 활동하시는 분들이 계십니다.<br />
                    하지만 매주 진행하는 <b>정기 세션</b>과 기수당 3회 열리는 <b>DevCamp(당일 및 1박 2일 해커톤)</b>에 필수적으로 참여해야 하며,<br />
                    특히 방학 중에는 원활한 프로젝트 진행을 위해 추가적인 팀 활동에 모여야 한다는 점을 숙지해주세요!`,
      isOpen: false,
    },
    {
      subTitle: '실력이 뛰어난 사람만 지원할 수 있나요?',
      description: `YAPP에서는 6개월간 <b>꾸준히 활동</b>할 수 있는지, 그리고 <b>발전하고자 하는 의지가 충분한지</b>를 가장 중요하게 생각합니다.<br />
                    그러나 교육보다는 프로젝트 진행이 중심이기 때문에 자율 스터디나 특강 이외의 교육 커리큘럼을 따로 진행하고 있지 않습니다.<br />
                    따라서 동아리 활동 이외에 <b>개인적으로도 시간과 노력을 투자해야 한다는 점</b>을 알아주시길 바랍니다.`,
      isOpen: false,
    },
    {
      subTitle: '정기 모임(세션)은 언제, 어디서 하나요?',
      description: `<b>매주 토요일 오후 2시-5시</b>, 세션은 서로 간의 지식 공유&친목 도모를 위해 진행되며 가벼운 뒤풀이도 있을 수 있습니다.<br />
                    다만, 코로나 상황에 따라 현재는 <b>전면 온라인으로 진행</b>되고 있으며 거리두기가 완화됨에 따라 오프라인 만남이 있을 수도 있습니다.<br />
